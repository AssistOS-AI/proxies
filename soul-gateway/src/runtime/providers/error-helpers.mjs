...
export function getProviderErrorType(error) {
  const body = error?.body || {};
  return body.error?.type || body.error?.code || body.__type || body.code || '';
}
...
export function classifyTransportOrServerError(provider, error, fallbackStatus = HTTP_STATUS.INTERNAL_SERVER_ERROR) {
