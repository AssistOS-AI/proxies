...
} from '../../management/account-view.mjs';
...
describe('management/account-view', () => {
    ...
    describe('buildAccountsPayload', () => {
        it('returns the account list and aggregate state for the dashboard', () => {
