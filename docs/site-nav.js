...
function computeDocsRoot() {
  var script = document.currentScript || document.querySelector('script[src*="site-nav"]');
  ...
  var rel = idx >= 0 ? rawPath.slice(idx + "/docs/".length) : rawPath.replace(/^\/+/, "");
...
function buildNav(root) {
  ...
  var links = [
    ...
    ["API Reference", "api/index.html", "api"],
    ["Configuration", "configuration/index.html", "configuration"],
    ["Middlewares", "middlewares/index.html", "middlewares"],
    ["Specs", "specs/index.html", "specs"],
    ["Wiki", "wiki/index.html", "wiki"]
  ];
